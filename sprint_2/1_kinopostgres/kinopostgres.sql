...
CREATE TABLE film (
    ...
    slogan text,
    director integer REFERENCES person,
    screenwriter integer REFERENCES person,
    producer integer REFERENCES person,
    operator integer REFERENCES person,
    composer integer REFERENCES person,
    editor integer REFERENCES person,
    budget money,
    marketing money,
    dvd_release date,
